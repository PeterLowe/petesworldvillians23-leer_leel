...
int main()
{
	...
	std::cout << "Pick a letter from A to A or B or Z to Z" << std::endl; // change this line each iteration
	std::cin >> letter;
	...
	if (letter == 'b' || letter == 'B') //written by LeeR
	{
		if (region == 1)
		{
		...
		if (region == 2)
		{
			std::cout << "Belarus, Belgium, Bulgaria, Bosnia" << std::endl;
		}
		if (region == 3)
		{
